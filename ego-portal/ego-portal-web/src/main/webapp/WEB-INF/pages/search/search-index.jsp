            ...
            <div class="s_hd">
                <div id="s_search">
                    <form onsubmit="return false;">
                        <input id="searchStr" name="searchStr" value="${searchStr}" class="search-input"/>
    ...
    <div id="s_bdw">
        <div id="s_bd">
            ...
            <div class="f-r rightlist">
                ...
                <div class="pagecon">
                    <div class="f-r pagination" id="pageContent">
                    </div><!--pagination end-->
                </div>
    ...
    <li>
        ...
        <dl>
            ...
            <dd><a class="addcat" href="javascript:void(0);"
                   ...
                   '{{=it[i].marketPrice}}', '{{=it[i].originalImg}}');">加入购物车</a></dd>
        </dl>
    </li>
    {{ } }}
</script>
...
<script type="template" id="pageTemplate">
    {{ if(it.hasPre){ }}
    <a href="javascript:void(0);" onclick="doSearch('{{=it.prePage}}');">&lt; 上一页</a>
    {{ } }}
    ...
    {{ if(it.hasNext){ }}
    <a href="javascript:void(0);" onclick="doSearch('{{=it.nextPage}}');">下一页 &gt; </a>
    {{ } }}

    <div class="yepage">到第
        <input class="stext" type="text" name="" id="pageBtn" value="1"/>页
        <input class="btnimg" type="button" onclick="pageBtnSearch();" name="" id="" value=""/>
    </div>
</script>
<script type="text/javascript">
    // 进入页面搜索商品信息
    ...
    // 搜索商品信息
    function doSearch(currentPage=1) {
        $.ajax({
            ...
            success: function (result) {
                if (result.count > 0) {
                    // 调用模板
                    var goodsTempl = doT.template($("#goodsTemplate").text());
                    // 填充内容
                    $("#goodsContent").html(goodsTempl(result.result));

                    // 调用模板
                    var pageTempl = doT.template($("#pageTemplate").text());
                    // 填充内容
                    $("#pageContent").html(pageTempl(result));
                } else {
                    layer.msg("亲，没有搜索到对应的商品！");
                }
            },
    ...
    // 到第几页
    function pageBtnSearch() {
        doSearch($("#pageBtn").val());
    }
</script>
</body>
</html>
