                        ...
                        <form action="" id="search-form2" class="navbar-form form-inline" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input name="goodsName" value="" placeholder="搜索词"
                                           id="goodsName"
...
<!-- /.content-wrapper -->
<!-- 引入doT.js -->
<script type="text/javascript" src="${ctx}/Public/js/doT.min.js"></script>
<!-- 编写商品模板 -->
...
<script>
     ...
     * @param pageNum
     */
    function ajax_get_table(pageNum=1) {
        $.ajax({
            url: "${ctx}/product/listForPage",
            type: "GET",
            data: {
                catId: $("#catId").val(),
                brandId: $("#brandId").val(),
