            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a onclick="checkHasGoods();" href="#tab_goods_images" data-toggle="tab">商品相册</a></li>
                    ...
                    <form method="post" id="addEditGoodsForm">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_tongyong">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <input type="hidden" id="extendCatId" name="extendCatId" value="0"/>
                                        <td>商品分类:</td>
                                        <td>
                                            <div class="col-xs-3">
                                            ...
                                            <div class="col-xs-3">
                                                <select name="cat_id_2" id="cat_id_2"
                                                        onchange="getCategory(this.value,'cat_id_3','0', 'catId');"
                                                        class="form-control" style="width:250px;margin-left:-15px;">
                                                    <option value="0">请选择商品分类</option>
                                                </select>
                                            </div>
                                        ...
                                        <td>
                                            <div class="col-xs-3">
                                                <select name="extend_cat_id" id="extend_cat_id"
                                                        onchange="getCategory(this.value,'extend_id_2','0', 'extendCatId');"
                                                        class="form-control" style="width:250px;margin-left:-15px;">
                                                    <option value="0">请选择商品分类</option>
                                                    <c:forEach items="${gcList}" var="gc">
                                                        <option value="${gc.id}">${gc.name}</option>
                                            ...
                                            <div class="col-xs-3">
                                                <select name="extend_cat_id_2" id="extend_id_2"
                                                        onchange="getCategory(this.value,'extend_id_3','0','extendCatId');"
                                                        class="form-control" style="width:250px;margin-left:-15px;">
                                                    <option value="0">请选择商品分类</option>
                                                </select>
                                            </div>
                                            <div class="col-xs-3">
                                                <select name="extend_cat_id_3" id="extend_id_3" class="form-control"
                                                        style="width:250px;margin-left:-15px;"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form enctype="multipart/form-data">
                                                <input id="file-product" class="file" name="file"
                            ...
                            <div class="tab-pane" id="tab_goods_images">
                                <form enctype="multipart/form-data">
                                    <input id="file-product-goodsImages" class="file" name="file"
                                           type="file" data-min-file-count="1" multiple>
                                </form>
                            </div>
                            <!--商品相册-->
                        ...
                        <div class="pull-right">
                            <input type="text" name="goods_id" id="goodsId" value="">
                            <button class="btn btn-primary"
                                    onclick="ajax_submit_form('addEditGoodsForm', '${ctx}/product/save',
                                            '${ctx}/product/add', '${ctx}/product/list', 'goodsId');"
...
// 属性输入框的加减事件
     ...
     *    allowedPreviewTypes允许上传文件的类型
     */
    $('#file-product-goodsImages').fileinput({
        language: 'zh',
     ...
     * 上传文件失败后 调用方法（回调函数）
     */
    $('#file-product-goodsImages').on('fileuploaderror', function (event, data, previewId, index) {
        var form = data.form,
            files = data.files, e
        xtra = data.extra,
            response = data.response,
     ...
     * 文件错误 比如文件类型错误 调用方法（回调函数）
     */
    $('#file-product-goodsImages').on('fileerror', function (event, data) {
        console.log(data.id);
        console.log(data.index);
        console.log(data.file);
        console.log(data.reader);
     ...
     * 文件上传成功后 调用方法（回调函数）
     */
    $('#file-product-goodsImages').on('fileuploaded', function (event, data, previewId, index) {
        var form = data.form,
            files = data.files,
            extra = data.extra,
            response = data.response,
    ...
    function checkHasGoods() {
        if(!$("#goodsId").val()) {
            ...
            $("#file-product-goodsImages").attr("disabled", true);
        } else {
            $("#file-product-goodsImages").attr("disabled", false);
        }
    }
    // --------------------------------商品相册 end------------------------------------
</script>
