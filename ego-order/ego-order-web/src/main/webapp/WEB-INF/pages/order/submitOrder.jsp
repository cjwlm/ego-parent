        ...
        <div id="s_bd">
            <form id="paymentForm" action="${ctx}/order/payment" method="post">
                ...
                <div class="osuccess">
                    ...
                    <p>我们将为您保留订单2日，如果2日后EGO网仍未收到您的付款，我们将自动取消此订单。<br/>商品预计到达时间：2011年11月06日，星期日，下午14:00-18:00，请您注意查收。</p>
                    <div class="ddinfo">
                        订单编号：${orderSn} <a class="blue" href="#">查看订单详情</a><br/>付款方式：在线支付 支付宝<br/>应付金额：<strong
                            class="red">￥${totalPrice}</strong>
                    </div>
                    <!-- 去付款 -->
                    <p class="gopay">
                        <a href="javascript:void(0);" onclick="payment();">
                            <img src="${ctx}/images/gopay.gif" width="88" height="36" alt=""/>
                        </a>
                    </p>
                ...
                <dl style="margin-top:10px;">
                    <dt>注意事项：</dt>
                    <dd>
                        1.“订单提交成功”仅表明EGO网收到了您的订单，只有您的订单通过审核后，才代表订单正式生效；<br/>2.选择货到付款/EGO快递的客户，请您务必认真检查所收货物，如有不符，您可以拒收；<br/>3.选择其他方式的客户，请您认真检查外包装。如有明显损坏迹象，您可以拒收该货品，并及时通知我们；<br/>4.建议在购买的15天内保留商品的全套包装、附件、发票等所有随货物品，以便后续的保修处理。
                    </dd>
                </dl>
            </form>
        </div><!--s_bd end-->
